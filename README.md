...
✔ Load and preprocess image data for two classes (tiger and lion)  
✔ Build a CNN model suitable for binary classification  
✔ Train and validate the model on the tiger vs lion dataset  
✔ Visualize training progress with graphs (e.g., loss & accuracy)  
